...
class _TvShowDetailsState extends State<TvShowDetails>
  ...
  void dispose() {
    ...
    createdByPageController.dispose();
    castPageController.dispose();
    crewPageController.dispose();
    networksPageController.dispose();
    productionCompaniesPageController.dispose();
    seasonsPageController.dispose();
    videosPageController.dispose();
    backdropsPageController.dispose();
    postersPageController.dispose();
